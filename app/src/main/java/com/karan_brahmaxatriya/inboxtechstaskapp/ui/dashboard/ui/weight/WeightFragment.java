...
public class WeightFragment extends Fragment {
    ...
    ArrayList<Weight> categoryArrayList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), AddWeightActivity.class);
        ...
        marqueCall.enqueue(new Callback<GetWeightModel>() {
            ...
            public void onResponse(@NonNull Call<GetWeightModel> call, @NonNull Response<GetWeightModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    categoryArrayList = object.getWeight();
    ...
    public class TopCategoryCustomAdapter extends RecyclerView.Adapter<TopCategoryCustomAdapter.MyViewHolder> {
        ...
        private ArrayList<Weight> moviesList;

        public TopCategoryCustomAdapter(ArrayList<Weight> moviesList) {
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            final Weight datum = moviesList.get(position);

            holder.tvCatName.setText(datum.getWeight() + "");

            holder.tvEdit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(getContext(), AddWeightActivity.class);
                    i.putExtra("name", datum.getWeight() + "");
            ...
            holder.tvDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    showProgressDialog();
                    Call<DeleteWeightModel> loginModelCall = RetrofitHelper.createService(RetrofitHelper.Service.class).DeleteWeightModel(hashMap);
                    loginModelCall.enqueue(new Callback<DeleteWeightModel>() {

                        @Override
                        public void onResponse(@NonNull Call<DeleteWeightModel> call, @NonNull Response<DeleteWeightModel> response) {
                            DeleteWeightModel object = response.body();
                            hideProgressDialog();
                            if (response.isSuccessful()) {
...
//                    labelNotification.setText(object.getResultMarque() + "");
                        ...
                        @Override
                        public void onFailure(@NonNull Call<DeleteWeightModel> call, @NonNull Throwable t) {
                            hideProgressDialog();
                            t.printStackTrace();
